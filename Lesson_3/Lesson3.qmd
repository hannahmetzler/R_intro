...
1.  On [https://github.com]():
    ...
    2.  Copy the SSH link.
2.  Clone the remote repository via the Terminal (quicker) or the Rstudio interface:
    1.  Terminal: navigate to your folder for this R course using `cd`. Type `git clone` and paste your SSH link.
    2.  Interface: Create a new project & choose `Version Control`, then `Git`. Under `Clone Git Repository`, enter your SSH link.
